...
public class Cpf2Test {
    ...
    @Test
    void testCpf() {
//        Assertions.assertEquals(true, AlgoritmosEmJava.cpf2(cpfTeste1));
//        assertEquals(true, AlgoritmosEmJava.cpf2(cpfTeste2));
//        assertEquals(true, AlgoritmosEmJava.cpf2(cpfTeste3));
//        assertEquals(false, AlgoritmosEmJava.cpf2(cpfTeste4));
//        assertEquals(false, AlgoritmosEmJava.cpf2(cpfTeste5));
//        assertThrows(IllegalArgumentException.class,
//                () -> AlgoritmosEmJava.cpf2(cpfTeste7));
//        assertThrows(IllegalArgumentException.class,
//                () -> AlgoritmosEmJava.cpf2(cpfTeste8));
    }
}